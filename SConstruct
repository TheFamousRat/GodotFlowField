...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'bin/', PathVariable.PathIsDirCreate))
...
godot_headers_path = "/home/thefamousrat/Documents/Godot/godot-cpp/godot-headers/"
cpp_bindings_path = "/home/thefamousrat/Documents/Godot/godot-cpp/"
...
###################
    ...
    env.Append(CCFLAGS=['-fPIC', '-g', '-Wwrite-strings','-lpthread','-pthread'])
